...
export const Features = () => {
  ...
  useGSAP(() => {
    ...
    animationWithGsapScroll("#features-title", {opacity: 1, y: 0});

    animationWithGsapScroll(".g_grow", {scale: 1, opacity: 1, ease: "power1"},{ scrub: 5.5 });

    animationWithGsapScroll(".g_text", {y: 0, opacity: 1, ease: "power2.inOut", duration: 1})
